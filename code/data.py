...
# needs better name
class SVDData(Data):
    def __init__( self, df, temporal_comps, spatial_comps, trial_starts ):
        self._df = df
    ...
    @property
    def pixel( self ):
        return SVDData.PixelSlice( self._temps, self._spats )
    ...
    def __getitem__( self, keys ):
        ...
        return SVDData( df, temps, spats, new_starts  )
