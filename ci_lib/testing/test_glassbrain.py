...
rfe_path = str(resl_path/Path('GN06/SVD/All/rfe/left_visual.left_tactile.left_vistact.right_visual.right_tactile.right_vistact/20/covariance_max_components~64/best_feats.pkl'))
